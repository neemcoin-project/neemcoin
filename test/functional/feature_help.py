...
"""Verify that starting neemcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start neemcoin with -h for help text")
        ...
        self.log.info("Start neemcoin with -version for version information")
        ...
        self.log.info("Start neemcoind with -fakearg to make sure it does not start")
