...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " neemcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  neemcoin-tx [options] <hex-tx> [commands]  Update hex-encoded neemcoin transaction\n" +
            "or:     neemcoin-tx [options] -create [commands]   Create hex-encoded neemcoin transaction\n" +
            "\n";
