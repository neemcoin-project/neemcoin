...
{
    const char* pszTimestamp = "Daily Mail 18/May/2021 NOW VACCINE REFUSENIKS THREATEN FREEDOM";
    const CScript genesisOutputScript = CScript() << ParseHex("04dafb3eef883f3225188612a7787551715a0a99063acfa748a7d962957e1364eacfe301cdc3cf885cf4cf589f905f95d870fa735172776ba00edac15eea057500") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1621366598, 2000358443, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3e6c73d6f61b30702f26251774deebc93e79141e6ba5b9a773f4828aad0e535e"));
        assert(genesis.hashMerkleRoot == uint256S("0x1ae850b599692a72a1213b6cfcad1d03ab5d625ccb4721a37744bdf02758ba20"));
        ...
        vSeeds.emplace_back("192.168.1.48");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.neemcointools.com");
        //vSeeds.emplace_back("dnsseed.neemcoinpool.org");
        ...
        checkpointData = {
            {
                {  101, uint256S("0x3f321c67daa1e996934b831df12a9c69acd59ae9cab6dd083b9c5cd8fd6db089")},
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1621366598, 747355, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1b688c31c735cea46044d7c11dfacd62ffde47ff4f18c5a6db0c8537e14ec227"));
        assert(genesis.hashMerkleRoot == uint256S("0x1ae850b599692a72a1213b6cfcad1d03ab5d625ccb4721a37744bdf02758ba20"));
        ...
        vSeeds.emplace_back("192.168.1.48");
        //vSeeds.emplace_back("seed-b.neemcoin.loshan.co.uk");
        ...
        checkpointData = {
            {
                {0, uint256S("1b688c31c735cea46044d7c11dfacd62ffde47ff4f18c5a6db0c8537e14ec227")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1621366598, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd473cedf77ec3d94827bcf23256e14b20e87ab8b71d6d05acdc498367b0901d9"));
        assert(genesis.hashMerkleRoot == uint256S("0x1ae850b599692a72a1213b6cfcad1d03ab5d625ccb4721a37744bdf02758ba20"));
        ...
        checkpointData = {
            {
                {0, uint256S("d473cedf77ec3d94827bcf23256e14b20e87ab8b71d6d05acdc498367b0901d9")},
            }
        };
