# Support for Output Descriptors in Neemcoin Core

Since Neemcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Neemcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Neemcoin Core wallets, a convenience function `combo` is
